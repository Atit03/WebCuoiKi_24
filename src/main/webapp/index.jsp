					...
					<div class="container">
						<div class="row">
							<div class="col-sm-7 col-md-9">
								<div id="colorlib-logo"><a href="index.html">UTESHOP</a></div>
							</div>
						...
						<div class="row">
							<div class="col-sm-12 text-left menu-1">
								<ul>
									...
									<li class="cart"><a href="cart.html"><i class="icon-shopping-cart"></i> Giỏ hàng
											[0]</a>
									</li>
								</ul>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="intro">UTESHOP nơi bạn an tâm về chất lượng!</h2>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="col-sm-6 text-center">
							<div class="featured">
								...
								<div class="desc">
									<h2><a href="men.html">Sản phẩm dành cho nam</a></h2>
								</div>
							</div>
						</div>
						<div class="col-sm-6 text-center">
							<div class="featured">
								...
								<div class="desc">
									<h2><a href="women.html">Sản phẩm dành cho nữ</a></h2>
								</div>
							</div>
						</div>
					</div>
